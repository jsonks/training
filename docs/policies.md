...
# Values
  ...
  - Collaboration: SEKnFind is a shared system with a shared patron database and shared responsibility for maintaining and expanding the system in a professional manner.
  ...
  - Support: The Southeast Kansas Library System (SEKLS) has made a long-term commitment to supporting SEKnFind as a primary system service.

    The Southeast Kansas Library System staff has a primary role for ongoing training and support, with extensive contributions of time and knowledge by SEKnFind participants.
